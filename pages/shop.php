  ...
  <div id="search-modal" class="search-modal">
    <div class="search-modal-content">
      <div class="search-modal-input">
        ...
        <input type="text" placeholder="جستجوی محصولات..." autofocus>
      ...
      <div class="search-modal-results">
        ...
        <div class="search-modal-item">
          ...
          <div class="search-modal-item-text">
            ...
            <div class="search-modal-item-desc">۳۴۹,۰۰۰ تومان</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="page-header">
      <div class="page-header-row">
        <div>
          ...
          <p class="page-subtitle">بیش از ۱۲,۰۰۰ محصول دیجیتال با کیفیت بالا</p>
        </div>
    ...
    <div class="layout-two-col-sidebar">
      ...
      <aside>
        <div class="card">
          <div class="card-header">
            <span class="font-semibold text-sm">فیلترها</span>
            <button class="btn btn-ghost btn-xs">پاک کردن</button>
          </div>
          <div class="card-body">
            <!-- Categories -->
            ...
            <div class="form-group mb-6">
              ...
              <div class="flex gap-2">
                <input type="text" class="form-input" placeholder="از">
                <input type="text" class="form-input" placeholder="تا">
              </div>
            </div>
      ...
      <div>
        ...
        <div class="flex items-center gap-2 mb-4">
          ...
          <span class="tag tag-active">قالب وب‌سایت <span class="cursor-pointer" style="margin-right:4px">✕</span></span>
        </div>
        ...
        <div class="content-grid content-grid-3">
          ...
          <div class="product-card">
            ...
            <div class="product-actions">
              <button class="btn btn-icon-only btn-sm btn-secondary">
